...
// Primary color family - used for key components like FAB, primary buttons
val md_theme_light_primary = Color(0xFF006C4C)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF89F8C7)
val md_theme_light_onPrimaryContainer = Color(0xFF002114)

// Secondary color family - used for less prominent components
...
// Tertiary color family - used for contrasting accents
...
// Primary color family - adjusted for dark backgrounds with proper contrast
...
// Background and surface colors - dark backgrounds with high contrast text
...
// Seed color used for Material Theme Builder generation
val seed = Color(0xFF006C4C) // Green theme reflecting food/health focus
