...
class HealthConnectManagerTest {
    ...
    fun `REQUIRED_PERMISSIONS contains READ_NUTRITION and WRITE_NUTRITION`() {
        ...
        assertThat(permissions).contains("android.permission.health.READ_TOTAL_CALORIES_BURNED")
    }
    ...
    fun `REQUIRED_PERMISSIONS contains correct number of permissions`() {
        ...
        assertThat(HealthConnectManager.REQUIRED_PERMISSIONS.size).isEqualTo(9)
    }
