...
class ErrorHandlerTest {
    ...
    fun `getUserMessage should return user-friendly messages for all error types`() {
        ...
        val testCases = mapOf(
            ...
            ErrorType.ServerError(500, "Internal Server Error") to
            ...
            ErrorType.ValidationError("calories", "must be between 1 and 5000") to
                "Invalid calories: must be between 1 and 5000",
            ErrorType.PermissionDenied(listOf("Health Connect")) to
